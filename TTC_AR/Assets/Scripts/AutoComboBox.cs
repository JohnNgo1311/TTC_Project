...
namespace UnityEngine.UI.Extensions
{
    ...
    public class AutoComboBox : MonoBehaviour
    {
        ...
        public void ToggleDropdownPanel(bool directClick = false)
        {
            ...
            _arrow_Button_Down.SetActive(!_arrow_Button_Down.activeSelf);
            _arrow_Button_Up.SetActive(!_arrow_Button_Down.activeSelf);
