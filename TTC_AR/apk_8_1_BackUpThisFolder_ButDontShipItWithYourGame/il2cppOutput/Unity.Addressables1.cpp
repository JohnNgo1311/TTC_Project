...
IL_00ac:
	...
	{// begin try (depth: 1)
		...
		}
		{
			...
			NullCheck(L_38);
			RuntimeObject* L_39;
			L_39 = VirtualFuncInvoker2< RuntimeObject*, RuntimeObject*, ObjectU5BU5D_t8061030B0A12A55D5AD8652A20C922FE99450918* >::Invoke(23 /* System.Object System.Reflection.PropertyInfo::GetValue(System.Object,System.Object[]) */, L_38, NULL, (ObjectU5BU5D_t8061030B0A12A55D5AD8652A20C922FE99450918*)NULL);
			V_16 = L_39;
			// if (v != null)
...
IL_00ff_1:
		{
			...
			NullCheck(L_48);
			FieldInfo_t* L_50;
			L_50 = VirtualFuncInvoker2< FieldInfo_t*, String_t*, int32_t >::Invoke(84 /* System.Reflection.FieldInfo System.Type::GetField(System.String,System.Reflection.BindingFlags) */, L_48, L_49, ((int32_t)88));
			V_14 = L_50;
			// if (fi != null)
