...
IL_0052:
	{
		...
		NullCheck(L_19);
		int64_t L_22;
		L_22 = VirtualFuncInvoker2< int64_t, int64_t, int32_t >::Invoke(30 /* System.Int64 System.IO.Stream::Seek(System.Int64,System.IO.SeekOrigin) */, L_19, L_21, 0);
...
IL_001b:
	{
		...
		NullCheck(L_12);
		int64_t L_15;
		L_15 = VirtualFuncInvoker2< int64_t, int64_t, int32_t >::Invoke(30 /* System.Int64 System.IO.Stream::Seek(System.Int64,System.IO.SeekOrigin) */, L_12, L_14, 0);
		// assetFileStream.Read(buffer, /* offset= */ 0, buffer.Length);
